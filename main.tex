...
\begin{enumerate}
	\item a natural language word, followed by a colon (e.g.~\lstinline{input:} and~\texttt{output:}),
	\item the word ``rule'', followed by a name and a colon (e.g. \texttt{rule\ convert\_to\_pdf:}),
	\item a quoted filename pattern (e.g. \texttt{"\{prefix\}.pdf"}),
