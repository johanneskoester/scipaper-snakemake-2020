...
By analyzing its readability, its modularization, portability, reporting, scheduling and caching abilities, we have shown how Snakemake supports all these aspects, and thereby provides a comprehensive framework for sustainable data analysis.
