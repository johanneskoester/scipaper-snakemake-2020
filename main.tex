...
\begin{abstract}
	Modern data analysis often entails a multitude of heterogeneous steps, from the application of command line tools to the usage of scripting languages like R or Python for the generation of plots and tables.
