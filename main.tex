...
Within $J^o$, all jobs that have only incoming edges from the partition of finished jobs (or no incoming edge et all) can be scheduled next.
...
Second, we aim to maximize the number of used cores, i.e.\ the extent of paralellization.
