...
The latter guarantees the second example scheduling solution (\autoref{fig:scheduling}c).

\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{scheduling.pdf}
	\caption{Snakemake scheduling problem. (a) Example workflow DAG with jobs ready for execution.
