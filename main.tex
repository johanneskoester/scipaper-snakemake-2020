...
Finally, for each temporary file $f \in F$, we define a variable $\delta_f \in \[0,\]$ indicating the fraction of consuming jobs that have already or will be scheduled.
...
Upon ties, jobs are preferred such that they reduce the life time of temporary files.
