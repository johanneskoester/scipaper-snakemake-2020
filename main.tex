...
First, workflow management systems like Galaxy~\parencite{Afgan2018} often referred to as ``science gateways``~\parencite{afgan_galaxy_2011} offer a graphical user interface for composition and execution of workflows.
