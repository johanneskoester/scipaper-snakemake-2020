...
Several of them are shared with other tools (e.g. Conda and Container integration), while others are (at the time of writing) exclusive to Snakemake (e.g., the scheduling mechanism, the graph partitioning).
...
In other words, $\delta_f = 1.0$ means that all consuming jobs will be completed after this scheduling round has been processed (i.e. the lifetime of that file is over and it can be deleted).
