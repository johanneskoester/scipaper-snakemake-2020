...
Where necessary, it is possible to provide arbitrary Python code to infer input files based on wildcard values or even conditionally depend on results from upstream jobs.
