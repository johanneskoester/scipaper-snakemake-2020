...
The resource usage of a group job is determined by performing a topological sort of the involved jobs, summing resource usage per level and taking the maximum over all levels.
