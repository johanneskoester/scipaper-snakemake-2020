...
Typically a data analysis consists of steps that are quite specific and unique to the analysis, as well as steps that are common to the scientific field and utilize reoccuring tools or libraries and a relatively standard way.
...
Via the command line interface, it is possible to instruct Snakemake to open a Jupyter notebook server for editing the notebook.
Within the notebook, 
